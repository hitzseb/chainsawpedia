...
class Character(models.Model):
    ...
    def __str__(self):
        return f'(Name: {self.name}, Image: {self.image}, Description: {self.description}, Source: {self.source}, Alias: {self.alias}, Species: {self.species}, Age: {self.age}, Height: {self.height}, Birthday: {self.birthday}, Birthplace: {self.birthplace}, Status: {self.status}, Contracted devils: {self.contracted_devils}, Contracted humans: {self.contracted_humans}, Manga debut: {self.manga_debut}, Anime debut: {self.anime_debut})'
